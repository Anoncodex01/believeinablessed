...
export default function AdminDashboard() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
        <StatCard dark icon={DollarSign} label="Total revenue" value={formatPrice(stats.total_revenue)} note={`${stats.completed_orders || 0} paid or delivered${stats.cancelled_orders ? ` · ${stats.cancelled_orders} cancelled` : ''}`} />
