...
export default function ReviewSection({
      ...
      <div className="flex gap-0.5">
        {STARS.map(star => (
          <Star
            ...
            size={size}
            fill={star <= (interactive ? hoverRating || rating : rating) ? '#171717' : 'none'}
            color={star <= (interactive ? hoverRating || rating : rating) ? '#171717' : '#D4D4D4'}
  ...
  const getStatusBadge = (status) => {
    const badges = {
      pending: { color: 'bg-neutral-100 text-neutral-950', icon: Clock, label: 'Pending' },
      approved: { color: 'bg-neutral-950/10 text-neutral-950', icon: CheckCircle, label: 'Approved' },
      rejected: { color: 'bg-neutral-100 text-neutral-950', icon: AlertCircle, label: 'Rejected' },
    };
    ...
    <div className="space-y-6" id="reviews">
      ...
      {stats && stats.total_reviews > 0 && !adminMode && (
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          ...
          <div className="card p-4 text-center">
            <div className="text-2xl font-bold text-neutral-950">{stats.verified_purchases || 0}</div>
            ...
            {[5, 4, 3, 2, 1].map(num => {
              ...
              return (
                ...
                >
                  ...
                  <Star className="w-4 h-4 text-neutral-950 fill-current" />
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex flex-wrap items-center gap-2 mb-1">
                      ...
                      {review.verified_purchase && (
                        <span className="flex items-center gap-0.5 text-xs text-neutral-950 bg-neutral-950/10 px-2 py-0.5 rounded-full">
                      ...
                      {!adminMode && (
                        <>
                          ...
                          <button
                            ...
                            className="flex items-center gap-1 text-xs text-[var(--text-secondary)] hover:text-neutral-950 transition-colors"
                          >
                      ...
                      {(review.is_owner || canModerate) && (
                        <>
                          ...
                          <button
                            ...
                            className="flex items-center gap-1 text-xs text-neutral-950 hover:text-neutral-950 transition-colors"
                          >
              ...
              <div className="text-center">
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    ...
                    className="flex-1 bg-neutral-950 hover:bg-neutral-800 text-white font-semibold px-4 py-2 rounded-xl transition-colors"
                  >
                    Delete
                  </button>
                </div>
